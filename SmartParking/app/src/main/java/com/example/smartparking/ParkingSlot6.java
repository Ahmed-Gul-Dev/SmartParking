...
public class ParkingSlot6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parking_slot6);

        slotview = (TextView) findViewById(R.id.pslotC);
        feesview = (TextView) findViewById(R.id.fees);
        node = db.getReference("ParkingSlots/UnAuthorize/3");
        ...
        slotnode.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(ParkingSlot6.this, "Connection Error", Toast.LENGTH_LONG).show();
            }
        });
