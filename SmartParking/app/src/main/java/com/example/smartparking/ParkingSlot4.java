...
public class ParkingSlot4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parking_slot4);

        slotview = (TextView) findViewById(R.id.pslotA);
        feesview = (TextView) findViewById(R.id.fees);
        node = db.getReference("ParkingSlots/UnAuthorize/1");
        ...
        slotnode.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(ParkingSlot4.this, "Connection Error", Toast.LENGTH_LONG).show();
            }
        });
